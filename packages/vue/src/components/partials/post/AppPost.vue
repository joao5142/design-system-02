  ...
  <app-box class="post" background="white-50">
    ...
    <div class="post__actions">
      ...
      >
        ...
        <app-box
          v-if="isModalSetReactionOpen"
          shadow
          class="post__actions-choice-reaction"
        >
          <img
            :src="LikeReaction"
            alt="like"
            @click.self="() => handleReactPost('like')"
          />
          <img
            :src="LoveReaction"
            alt="love"
            @click.self="() => handleReactPost('love')"
          />
          <img
            :src="LaughReaction"
            alt="laugh"
            @click.self="() => handleReactPost('laugh')"
          />
          <img
            :src="SadReaction"
            alt="sad"
            @click.self="() => handleReactPost('sad')"
          />
          <img
            :src="AngryReaction"
            alt="angry"
            @click.self="() => handleReactPost('angry')"
          />
        </app-box>
      </div>
